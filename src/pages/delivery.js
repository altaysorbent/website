    ...
    <Layout>
      ...
      <div className="container mx-auto px-2 pt-4 max-w-5xl text-xl">
        <div className="text-justify">
          <p className="mb-2">
            Доставка осуществляется курьерской службой CDEK по странам СНГ.
          </p>
          <p className="mb-2">
        ...
        <div className="mt-6">
          <h4 className="text-2xl font-bold">Информация о продавце</h4>
          <p>Товарищество с ограниченной ответственностью "АКТАС"</p>
          <p>БИН: 921240000388</p>
          <p>
            Адрес: Восточно-Казахстанская область , г.Усть-Каменогорск, проспект
            Ауэзова, 14/1, офис 308
          </p>
        </div>
      </div>
    </Layout>
