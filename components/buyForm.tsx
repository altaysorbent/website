...
const BuyForm = (): JSX.Element => {
  ...
  const [destinationCity, setDestinationCity] = useState<
    ICDEKCityItem | string | null
  >(null);
  const [destinationZipCode, setDestinationZipCode] = useState(null);
  ...
  const isReadyToOrder =
    name?.length > 0 &&
    phone?.length > 0 &&
    destinationZipCode?.length > 0 &&
    (isCDEKCompanySelected
      ? deliveryPriceKzt > 0
      : destinationAddress?.length > 0 &&
        (destinationCity as string)?.length > 0);

  const isBuyButtonDisabled = isReadyToOrder === false || loading;
  ...
  useEffect(() => {
    if (
      ...
      getDeliveryPrice({
        ...
        receiverCityId: (destinationCity as ICDEKCityItem).uid,
        quantity: count,
  ...
  const onCreateOrderButtonClick = () => {
    ...
    if (isCDEKCompanySelected) {
      optionalFields = {
        city: (destinationCity as ICDEKCityItem).name,
        cityFull: (destinationCity as ICDEKCityItem).label,
        cityId: (destinationCity as ICDEKCityItem).uid,
        tariffId: deliveryType,
      };
    } else {
      optionalFields = {
            ...
            <div className="w-full mx-auto">
              ...
              <div className="w-full mb-4">
                <FormControl component="fieldset">
                  ...
                  <RadioGroup
                    ...
                    onChange={onDeliveryCompanyChange}
                  >
                    <FormControlLabel
              ...
              {isCDEKCompanySelected ? (
                <CDEKDeliveryForm
                  ...
                  destinationCity={destinationCity as ICDEKCityItem}
            ...
            <div className="w-full max-w-3xl mx-auto">
                  ...
                  <tr>
                    ...
                    <td>
                      {destinationZipCode && deliveryPriceKzt >= 0 && (
                        <>
                          <p>
                            до {destinationZipCode}, г.
                            {(destinationCity as ICDEKCityItem)?.name},{' '}
                            {destinationAddress} - {deliveryPriceKzt}
              ...
              <button
                ...
                className={classNames({
                  ...
                  'bg-gray-500 hover:bg-blue-gray cursor-not-allowed': isBuyButtonDisabled,
