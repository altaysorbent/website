    ...
    <Layout>
      ...
      <div className="container mx-auto px-2 pt-4 text-xl text-justify">
        ...
        <ul className="list-disc lg:ml-10">
          ...
          <li>заболеваниях желудочно- кишечного такта (гастрит, язвенная болезнь желудка, дисбактериоз и др)</li>
        ...
        <br />
        <p>
          <i>«Алтайорбент» зарегистрирован как биологически активная добавка. Не является лекарственным средством.</i>
        </p>
      </div>
    </Layout>
  );
